...
struct ReminderView: View {
    ...
    var lightTextColor: Color = .yell // Adjusted to .yellow
    var waterAmountTextColor: Color = .babyBlu // Adjusted to .blue
    ...
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading) {
                ...
                // Extract room for top components
                let roomComponent = components.first(where: { $0.contains("Room:") })

                // Display room side by side
...
#Preview {
    ReminderView(reminder: Reminder(text: "Plant: Pothos, Room: Bedroom, Light: Full Sun, Water Amount: 20-50 ml", isChecked: false), toggleAction: {})
}
